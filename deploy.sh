...
REPO_NAME="rosbag-workflow-airflow"  # Should match the ecr repository name given in config.json
IMAGE_NAME="rosbag-workflow-airflow" # Should match the image name given in config.json
